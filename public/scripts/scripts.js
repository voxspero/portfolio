...
if (document.URL.indexOf('/nodeprojects') >= 0) {
	var navlink = document.getElementById('navNodeProjectBorder');
	navlink.classList.add('nav-link-border-active');
	var footerlink = document.getElementById('footerNodeProjectLink');
	footerlink.classList.add('footer-link-active');
}
