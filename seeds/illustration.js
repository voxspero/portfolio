const   faker        = require("faker"),
    ...
    {
        path: "../img/illustration/homequake.png",
    ...
    {
        path: "../img/illustration/junk-food-chips.png",
    ...
    {
        path: "../img/illustration/junk-food-2liter.png",
